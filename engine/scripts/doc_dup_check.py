...
Usage:
  python3 engine/scripts/doc_dup_check.py --app-path apps/<app_name>
  python3 engine/scripts/doc_dup_check.py --path /specific/file.md
  python3 engine/scripts/doc_dup_check.py --scan-all          # 扫描所有 apps
"""
